...
pub fn add_100_2d(c: &mut Criterion) {
    ...
    for size in [100, 1_000, 10_000, 100_000, 1_000_000].iter() {
        ...
        group.bench_with_input(BenchmarkId::from_parameter(size), size, |b, &size| {
            ...
            let mut points = vec![];
            let mut kdtree = KdTree::with_per_node_capacity(16, 2).unwrap();
            for _ in 0..size {
...
pub fn add_100_3d(c: &mut Criterion) {
    ...
    for size in [100, 1_000, 10_000, 100_000, 1_000_000].iter() {
        ...
        group.bench_with_input(BenchmarkId::from_parameter(size), size, |b, &size| {
            ...
            let mut points = vec![];
            let mut kdtree = KdTree::with_per_node_capacity(16, 3).unwrap();
            for _ in 0..size {
...
pub fn add_100_4d(c: &mut Criterion) {
    ...
    for size in [100, 1_000, 10_000, 100_000, 1_000_000].iter() {
        ...
        group.bench_with_input(BenchmarkId::from_parameter(size), size, |b, &size| {
            ...
            let mut points = vec![];
            let mut kdtree = KdTree::with_per_node_capacity(16, 4).unwrap();
            for _ in 0..size {
